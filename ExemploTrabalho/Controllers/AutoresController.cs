...
namespace ExemploTrabalho.Controllers
{
    public class AutoresController : Controller
    {
        ...
        public AutoresController(ExemploContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Autores != null ? 
                          ...
                          Problem("Entity set 'ExemploContext.Autores'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int? id)
        {
            ...
            {
                return Problem("Entity set 'ExemploContext.Autores'  is null.");
            }
            var autor = await _context.Autores.FindAsync(id);
            if (autor != null)
            {
